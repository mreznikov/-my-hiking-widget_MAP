// === ПОЛНЫЙ КОД JAVASCRIPT ВИДЖЕТА (Версия: v9.6) ===
...
async function getEnsuredTableId() {
    ...
    // Fallback to hardcoded table ID if other methods failed
...
console.log("DEBUG: grist_map_widget_hiking.js (v9.6): Запуск checkApis.");
checkApis();
// === КОНЕЦ СКРИПТА ===
